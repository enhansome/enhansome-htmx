...
* [GitHub](https://github.com/bigskysoftware/htmx) ⭐ 49,384 | 🐛 285 | 🌐 JavaScript | 📅 2026-09-08
...
* [django-htmx](https://github.com/adamchainz/django-htmx) ⭐ 2,009 | 🐛 13 | 🌐 JavaScript | 📅 2026-09-07 - Django integration.
...
* [Clace](https://github.com/claceio/clace) ⭐ 970 | 🐛 1 | 🌐 Go | 📅 2026-09-07 - Hypermedia based internal tools for teams. Application server for containerized apps.
...
* [htmx-spring-boot](https://github.com/wimdeblauwe/htmx-spring-boot) ⭐ 684 | 🐛 4 | 🌐 Java | 📅 2026-09-02 - Spring Boot support library for htmx
...
* [HTMX for ⚡️ fiber](https://github.com/ZEISS/fiber-htmx) ⭐ 6 | 🐛 0 | 🌐 CSS | 📅 2026-09-07 - A middleware to render [HTMX](https://github.com/katallaxie/htmx) ⭐ 3 | 🐛 0 | 🌐 CSS | 📅 2026-09-07 components.
...
* [GO HTMX](https://github.com/donseba/go-htmx) ⭐ 597 | 🐛 1 | 🌐 Go | 📅 2026-04-07 - Seamless HTMX Integration for Go Applications.
...
* [django-htmx example app](https://github.com/adamchainz/django-htmx/tree/main/example) ⭐ 2,009 | 🐛 13 | 🌐 JavaScript | 📅 2026-09-07 - Example Django app showing a few patterns.
...
* [quarkus-htmx-todos](https://github.com/derkoe/quarkus-htmx-todos) ⭐ 50 | 🐛 4 | 🌐 Java | 📅 2026-09-05 - Todo App in Quarkus with htmx.
