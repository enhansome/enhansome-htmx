...
* [GitHub](https://github.com/bigskysoftware/htmx) ⭐ 48,974 | 🐛 674 | 🌐 JavaScript | 📅 2026-08-15
...
* [django-htmx](https://github.com/adamchainz/django-htmx) ⭐ 2,003 | 🐛 10 | 🌐 JavaScript | 📅 2026-08-16 - Django integration.
* [DelphiMVCFramework](https://github.com/danieleteti/delphimvcframework) ⭐ 1,396 | 🐛 20 | 🌐 Pascal | 📅 2026-08-11 - DelphiMVCFramework integration support for htmx (class helper in MVCFramework.HTMX)
* [Clace](https://github.com/claceio/clace) ⭐ 935 | 🐛 1 | 🌐 Go | 📅 2026-08-17 - Hypermedia based internal tools for teams. Application server for containerized apps.
...
* [htmx-spring-boot](https://github.com/wimdeblauwe/htmx-spring-boot) ⭐ 688 | 🐛 4 | 🌐 Java | 📅 2026-03-14 - Spring Boot support library for htmx
* [htmx.net](https://github.com/khalidabuhakmeh/htmx.net) ⭐ 578 | 🐛 3 | 🌐 C# | 📅 2026-03-02 - ASP.NET Core integration (Htmx Extension Methods, TagHelpers, Htmx.Config)
* [laravel-htmx](https://github.com/mauricius/laravel-htmx) ⭐ 365 | 🐛 3 | 🌐 PHP | 📅 2026-03-19 - Laravel integration for htmx.
* [elem-go](https://github.com/chasefleming/elem-go) ⭐ 364 | 🐛 5 | 🌐 Go | 📅 2026-07-20 - A Go library for building HTML with htmx.
* [htmx-debugger](https://github.com/NomadicDaddy/htmx-debugger) ⭐ 145 | 🐛 1 | 🌐 JavaScript | 📅 2026-07-30 - A Chrome extension for debugging and viewing htmx events and attributes
...
* [HTMX for ⚡️ fiber](https://github.com/ZEISS/fiber-htmx) ⭐ 6 | 🐛 0 | 🌐 CSS | 📅 2026-08-18 - A middleware to render [HTMX](https://github.com/katallaxie/htmx) ⭐ 3 | 🐛 0 | 🌐 CSS | 📅 2026-08-18 components.
* [HTMX](https://github.com/katallaxie/htmx) ⭐ 3 | 🐛 0 | 🌐 CSS | 📅 2026-08-18 🔨Write HTML and HTMX applications in pure Go and a lot more.
...
* [babashka-htmx-todoapp](https://github.com/prestancedesign/babashka-htmx-todoapp) ⭐ 176 | 🐛 0 | 🌐 Clojure | 📅 2024-03-14 - Quick example of a todo list application using Babashka and htmx.
* [panas.example](https://github.com/keychera/panas.example) ⭐ 27 | 🐛 1 | 🌐 Clojure | 📅 2023-05-27 - Implementation of all [htmx examples](https://htmx.org/examples/) using Babashka.
* [contact.app-clj](https://github.com/rmrt1n/contact.app-clj) ⭐ 3 | 🐛 0 | 🌐 Clojure | 📅 2024-04-09 - Clojure implementation of the contact.app from the Hypermedia Systems book

### Common Lisp

* [cl-trello-clone](https://github.com/rajasegar/cl-trello-clone) ⭐ 42 | 🐛 0 | 🌐 Common Lisp | 📅 2021-07-19 - A small Trello clone built in Common Lisp
* [ccl-demo-raja](https://github.com/rajasegar/ccl-demo-raja) ⭐ 20 | 🐛 0 | 🌐 Common Lisp | 📅 2021-07-01 - A Common Lisp demo with htmx using Star wars API.
* [cl-github-timeline](https://github.com/rajasegar/cl-github-timeline) ⭐ 15 | 🐛 0 | 🌐 HTML | 📅 2021-08-02 Github timeline in Common Lisp, and [another example based on this one](https://github.com/vlcinsky/python-fastapi-github-timeline) ⭐ 5 | 🐛 0 | 🌐 CSS | 📅 2021-08-04 using FastAPI.
...
* [TodoMVC App](https://github.com/syarul/htmx-todomvc) ⭐ 11 | 🐛 0 | 🌐 TypeScript | 📅 2023-10-16 - TodoMVC App built with `Typescript`, `JSX`, `express`, `htmx` and `_hyperscript` deployed on vercel/netlify.

### AdonisJS

* [TodoMVC App](https://github.com/syarul/todomvc-adonisjs-react-htmx-_hyperscript) ⭐ 0 | 🐛 0 | 🌐 TypeScript | 📅 2024-08-12 - TodoMVC App built with `AdonisJS`, `htmx` and `_hyperscript` following the standard AdonisJS guidelines for server framework

### Express

* [todomvc-htmx](https://github.com/rajasegar/todomvc-htmx) ⭐ 71 | 🐛 3 | 🌐 CSS | 📅 2021-04-05 - TodoMVC app implemented using htmx and hyperscript.
* [htmx-twitter-clone](https://github.com/rajasegar/htmx-twitter-clone) ⭐ 44 | 🐛 1 | 🌐 JavaScript | 📅 2021-04-08 - A Twitter clone built using htmx.
* [htmx-calendar](https://github.com/rajasegar/htmx-calendar) ⭐ 18 | 🐛 0 | 🌐 Pug | 📅 2022-08-09 - Calendar component in htmx.
* [htmbox](https://github.com/rajasegar/htmx-dropbox) ⭐ 17 | 🐛 0 | 🌐 Pug | 📅 2021-03-31 - A Dropbox clone in htmx.
* [htmx-notes](https://github.com/rajasegar/htmx-notes) ⭐ 16 | 🐛 0 | 🌐 CSS | 📅 2021-04-08 - A Note-taking app using Markdown inspired by React Server Components demo.
* [htmx-tabular](https://github.com/rajasegar/htmx-tabular) ⭐ 13 | 🐛 0 | 🌐 Pug | 📅 2021-03-31 - Tabular data with htmx.
* [super-rentals-htmx](https://github.com/rajasegar/super-rentals-htmx) ⭐ 8 | 🐛 0 | 🌐 CSS | 📅 2021-04-08 - A Rentals Listing demo app built with htmx.
* [htmx-github-search](https://github.com/rajasegar/htmx-github-search) ⭐ 8 | 🐛 0 | 🌐 CSS | 📅 2021-03-08 - A GitHub Profile search component built using htmx.
* [Geo Selector in htmx](https://github.com/rajasegar/htmx-geo-selector) ⭐ 5 | 🐛 0 | 🌐 JavaScript | 📅 2021-08-06 - A Region, Sub-Region and Country selector based on user selections.
* [hx-swap-demo](https://github.com/rajasegar/hx-swap-demo) ⭐ 5 | 🐛 0 | 🌐 Pug | 📅 2021-03-13 - A demo app to showcase different attribute values of hx-swap in htmx.
* [todo-htmx](https://github.com/rajasegar/todo-htmx) ⭐ 5 | 🐛 0 | 🌐 Pug | 📅 2021-03-07 - A simple Todo list with Express and htmx.

### Rust

* [TodoMVC App](https://github.com/syarul/todomvc-rust-astra-maud-htmx-_hyperscript) ⭐ 6 | 🐛 0 | 🌐 Rust | 📅 2024-01-11 - TodoMVC App built with `Rust`, `Astra`, `maud`, `HTMX` and `_hyperscript`. Astra runs a small event I/O loop and maud is blazing fast, super type-safe, and easy to deploy.
...
* [htmx-ktor](https://github.com/Rattlyy/htmx-ktor) ⭐ 30 | 🐛 1 | 🌐 Kotlin | 📅 2026-01-25 - Fullstack CRUD app example made with Ktor (Backend), kotlin.html (Templates), SimpleCSS (Styling), PostgreSQL (DB), Docker (Deployment)
* [todo-hda-kt](https://github.com/corlaez/todo-hda-kt) ⭐ 9 | 🐛 0 | 🌐 Kotlin | 📅 2023-06-21 - TodoApp as a Hypermedia Driven App with parallel browser tests

### Python-based (Django, FastAPI, Flask)

* [django-htmx example app](https://github.com/adamchainz/django-htmx/tree/main/example) ⭐ 2,003 | 🐛 10 | 🌐 JavaScript | 📅 2026-08-16 - Example Django app showing a few patterns.
* [awesome-python-htmx](https://github.com/PyHAT-stack/awesome-python-htmx) ⭐ 1,332 | 🐛 14 | 📅 2024-08-20 - Awesome list for htmx specific to the Python ecosystem.
* [fast-htmx](https://github.com/marty331/fasthtmx) ⭐ 273 | 🐛 2 | 🌐 CSS | 📅 2024-01-15 - Fast-HTMX is a demo project of FastAPI an HTMX. The purpose of this project is to illustrate how to create a website with no JavaScript, using only HTML, CSS, and Python.
...
* [django-htmx-todo-list](https://github.com/OmenApps/django-htmx-todo-list) ⭐ 86 | 🐛 1 | 🌐 Python | 📅 2022-02-22 - Expands on django-htmx-todo to add task creation, editing, and deletion using FBVs.
* [django-tailwind-alpine-htmx](https://github.com/AccordBox/django-tailwind-alpine-htmx) ⭐ 64 | 🐛 0 | 🌐 JavaScript | 📅 2023-06-15 A simple Task app built with Django, Tailwind CSS, Alpine.js and HTMX
* [htmx and SSE with FastAPI](https://github.com/vlcinsky/fastapi-sse-htmx) ⭐ 43 | 🐛 0 | 🌐 Python | 📅 2021-06-05 - FastAPI based web app sending Server Sent Events to frontend app created with htmx.
* [flask-htmx-boilerplate](https://github.com/marcusschiesser/flask-htmx-boilerplate) ⭐ 37 | 🐛 1 | 🌐 HTML | 📅 2021-10-18 - Boilerplate template for a Python Flask application with HTMX and Tailwind CSS
* [owela-club](https://github.com/adamchainz/owela-club) ⭐ 35 | 🐛 0 | 🌐 Python | 📅 2022-05-31 - Play the Namibian game of Owela against a terrible AI. Built using Django and htmx.
* [Django HTMLX Material Kit](https://github.com/app-generator/sample-django-htmlx-mkit) ⭐ 19 | 🐛 0 | 🌐 SCSS | 📅 2022-05-04 - Simple starter powered by `Django`, `HTMLX` and `Bootstrap 5`
* [Flask HTMLX Material Kit](https://github.com/app-generator/sample-flask-htmlx-mkit) ⭐ 18 | 🐛 0 | 🌐 SCSS | 📅 2022-05-04 - Simple starter powered by `Flask`, `HTMLX` and `Bootstrap 5`
* [django-htmx-todo](https://github.com/jaredlockhart/django-htmx-todo) ⭐ 8 | 🐛 0 | 🌐 Python | 📅 2020-11-14
* [Flask-Sock HTMX](https://github.com/paluigi/flask-htmx) ⭐ 6 | 🐛 0 | 🌐 JavaScript | 📅 2022-04-18 - Very short example combining HTMX with [Flask-Sock](https://flask-sock.readthedocs.io/en/latest/) for self-updating webpages with minimal dependencies.
* [Lexicon App](https://github.com/jgirardet/djlexique) ⭐ 2 | 🐛 0 | 🌐 JavaScript | 📅 2023-03-20 - Lexicon app using django3.2, htmx, hyperscript.
* [dj\_pug\_htmx\_example](https://github.com/katsko/dj_pug_htmx_example) ⭐ 1 | 🐛 0 | 🌐 Python | 📅 2021-01-10 - HTMX, Pug, and Django experiments

### Ruby

* [sinatara-htmx](https://github.com/johnthethird/sinatra-htmx) ⭐ 18 | 🐛 0 | 🌐 HTML | 📅 2020-08-14 - Example of a Sinatra app using HTMX for implementing an interactive search
* [htmx-todo-app](https://github.com/libsyz/htmx-to-do-app) ⭐ 8 | 🐛 0 | 🌐 HTML | 📅 2020-06-07 - A little to-do app and a short demo of htmx built with Sinatra.
* [pokebutt-htmx](https://github.com/beechnut/pokebutt-htmx) ⭐ 2 | 🐛 2 | 🌐 HTML | 📅 2023-03-16 - Pokebutt clone using htmx.
...
* [dmvcframework-todo-app](https://github.com/danieleteti/delphi-dmvcframework-htmx-todo) ⭐ 21 | 🐛 0 | 🌐 Pascal | 📅 2026-07-03 - DelphiMVCFramework to-do app with HTMX and TemplatePro templates

### Zig

* [zig-htmx](https://github.com/hendriknielaender/zig-htmx) ⭐ 29 | 🐛 0 | 🌐 Zig | 📅 2026-04-05 - Example chat app written in zig + htmx (websockets).
* [zig-htmx-tailwind-example](https://github.com/dgv/zig-htmx-tailwind-example) ⭐ 12 | 🐛 0 | 🌐 Zig | 📅 2026-05-12 - CRUD app written in Zig + HTMX + Tailwind CSS.

### Lua

* [TodoMVC App](https://github.com/syarul/todomvc-lua-luasocket-htmx-_hyperscript) ⭐ 2 | 🐛 0 | 🌐 Lua | 📅 2024-10-13 - TodoMVC App built with `Lua`, `Luasocket`, `HTMX` and `_hyperscript`. Lua is fast and lightweight where virtually map very close to C.
...
* [demo-htmx-manifest](https://github.com/brunobuddy/demo-htmx-manifest) ⭐ 4 | 🐛 0 | 🌐 HTML | 📅 2024-10-22 - Newsletter signup app with Manifest + HTMX.

### Other

* [htmx-ai](https://github.com/bufferhead-code/htmx-ai) ⭐ 76 | 🐛 1 | 🌐 HTML | 📅 2024-02-07 - Use ChatGPT Code Generation as a Backend for HTMX
* [quarkus-htmx-todos](https://github.com/derkoe/quarkus-htmx-todos) ⭐ 50 | 🐛 2 | 🌐 Java | 📅 2026-08-16 - Todo App in Quarkus with htmx.
